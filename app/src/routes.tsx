...
export const routeConfig = {
  ...
  expenses: { name: 'expenses', options: { title: 'Expenses', header: header('Expenses') } },
  expenseReports: { name: 'expenseReports', options: { title: 'Reports', header: header('Expense Reports') } },
  expenseTags: { name: 'expenseTags', options: { title: 'Tags', header: header('Expense Tags') } },
  ...
  expenseCreate: { name: 'expenseCreate', options: { title: 'Expense claim', header: header('Expense Claim') } },
