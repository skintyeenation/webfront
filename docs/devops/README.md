...
| [postgres-hosting-options.md](./postgres-hosting-options.md) | Full landscape of Azure Postgres options (Flexible Server, Cosmos DB for PostgreSQL, self-managed VM, Aurora Serverless cross-cloud) — and why we picked Flexible Server B1ms. Companion rationale doc to ADR-7. |
