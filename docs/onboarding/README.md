...
| 2 | Install + sign into 1Password | The admin sends you a 1Password invite email and (separately) a printed/sealed Secret Key envelope or PDF | [1password.md](./1password.md) — download the desktop app from <https://1password.com/downloads/mac> (macOS) or <https://1password.com/downloads/windows> (Windows) |
