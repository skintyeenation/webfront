...
const SECTORS: { name: string; blurb: string; topic: string; lock: number; Icon: LucideIcon }[] = [
  { name: 'Oil & Gas', blurb: 'Primarily natural gas — development and revenue-sharing across our territory.', topic: 'refinery', lock: 61, Icon: Flame },
  { name: 'Minerals & Mining', blurb: 'Responsible mineral exploration and mining partnerships.', topic: 'quarry', lock: 62, Icon: Pickaxe },
  { name: 'Housing & Economic Development', blurb: 'Homes, infrastructure, and band-owned enterprise.', topic: 'construction', lock: 63, Icon: Building2 },
  { name: 'Forestry & Conservation', blurb: 'Sustainable forestry and stewardship of our lands and waters.', topic: 'forest', lock: 64, Icon: Trees },
  { name: 'Telecommunications', blurb: 'Connectivity and broadband infrastructure for the community.', topic: 'antenna', lock: 65, Icon: RadioTower },
];
        ...
        >
          {SECTORS.map((s) => (
            ...
            >
              ...
              <img
                src={`https://loremflickr.com/600/400/${s.topic}?lock=${s.lock}`}
                alt={s.name}
                width={600}
                height={400}
                loading="lazy"
